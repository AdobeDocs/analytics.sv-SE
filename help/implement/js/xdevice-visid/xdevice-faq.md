...
Enhetsövergripande analys är Adobe senaste metod för identifiering av besökare på olika enheter. Den använder Experience Cloud ID-tjänsten och fältbaserad sammanfogning för att retroaktivt sammanfoga besök från olika enheter. CDA kräver att funktionen `setCustomerIDs` används för att avgöra vilka enheter som används av samma besökare.
+++
