...
När en icke-autentiserad kund först kommer till er webbplats tilldelas den kunden en besökarprofil av Adobe Analytics. När den nya profilen skapas avslutas ett besök och ett nytt besök börjar.
...
* Varje rad är en träff, en enda förfrågan som skickas till Analytics datainsamlingsservrar.
...
Exemplet nedan visar hur data skickas till Adobe Analytics när en kund autentiserar på en ny enhet efter att ha autentiserat sig på en annan enhet.
