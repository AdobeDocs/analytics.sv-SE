...
1. Lägg till en regel för direktanrop som utlöser en analysfyr med `websiteBot` som identifierare. I det här exemplet används ett `s.tl`-anrop:

   ![websiteBot-identifierare](assets/websitebot.png)

1. Starta Adobe Analytics - Ställ in variabler och Adobe Analytics - Skicka Beacon-åtgärder i regeln för direktanrop.  Ett sätt att göra detta visas i följande exempel:
