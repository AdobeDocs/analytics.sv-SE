---
description: Svar på frågor ni kan ha när ni implementerar Audience Analytics.
...
Svar på frågor ni kan ha när ni implementerar Audience Analytics.
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_F0984CEF80DB4B589716BC55549E32B8"> 
     <li id="li_9BC3819784A9408F846D60FF0F20AAF9">Dessa gäller inte när Adobe Analytics-data skickas till Adobe Audience Manager. </li> 
     <li id="li_050A1BF9978E436895B5C7E33A82527D">Fråga dig själv: Kommer ni att dela ett analysdelat segment med en MCA-dimension tillbaka till Experience Cloud? </li> 
     <li id="li_C52D969681B94F4AAA18FDEB21EC5B49">Exporterar ni (t.ex. via dataflöden) ut till ett Business Intelligence-system (BI) som används för dessa ändamål? </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>

## AAM-specifika frågor {#section_6BDF746BA6464359A6A89A64EB025D12}
...
<table id="table_15B44592161240BDA79F3B020EA9CC9D"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>En Analytics-destination försvinner från ett segments målmappningsavsnitt när du väljer alternativet <span class="uicontrol"> Mappa automatiskt alla aktuella och framtida segment </span> i <span class="uicontrol"> Segmentmappningar </span>. </p> <p><img placement="break" align="left"  src="assets/auto-mapping.png" id="image_670ED5A306784FCBA8A0B336AC1F0FC6" width="300px" /> </p> <p>Du kan förhindra detta genom att välja <span class="uicontrol"> Mappa segment manuellt </span> i stället för alternativet Automatisk. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>F: Får jag all information från AAM i Analytics?</b> </p> </td> 
   <td colname="col2"> <p>Nej, endast data som är relaterade till personer som kommer till din webbplats under eller efter aktiveringen av Audience Manager-målgrupper och under/efter-kvalificering av segment. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_19AEAE0A3575423CB4F5F164DB5626D5"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nästan överallt. de behandlas på samma sätt som andra dimensioner som samlas in i Analytics. Det finns ett undantag: För närvarande finns inga data i Data Workbench. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>F: Varför ser jag inte data som kommer in i Analytics?</b> </p> </td> 
   <td colname="col2"> <p>Du har antagligen inkompatibla AAM-sekretesskontroller mellan datakällor och mål. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_B8938FD08C6F4F2387EDADDEF8089319"> 
     <li id="li_50A9BDF612304062913370F16BC882EF">Dina AAM-dataexportkontroller på målet och i segmentets datakällor kan vara i konflikt, vilket förhindrar att vissa segment skickas. </li> 
  ...
  <tr> 
   <td colname="col1"> <p><b>F: Varför ser jag"Målgruppsgräns nådd" i min Analytics-rapport? (Obs! this kommer också att representeras som Audience ID = -1 och "::max_audiences_Over:::" i datalagret)</b> </p> </td> 
   <td colname="col2"> <p>Som standard skickar Audience Analytics-integreringen för AAM alla segment som en besökare kvalificerar sig för till Analytics, utifrån antalet träffar. Om en besökare tillhör mer än 150 AAM-segment i en enda träff skickas de <b>150 senast kvalificerade segmenten</b> till Analytics, medan den återstående listan trunkeras. </p> <p>En extra flagga skickas till Analytics som anger att segmentlistan trunkerades och visas som"Målgräns nådd" i dimensionen Målgruppsnamn och"-1" i dimensionen Målgrupps-ID. </p> <p>Det är osannolikt att en besökare kvalificerar sig för mer än 150 segment för en viss träff, men det kan hända en liten del av tiden. Om du upplever"Målgruppsgräns nådd" i din rapportering har du två alternativ: </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nej. AAM-målgrupper ingår i Analytics på serversidan. Detta medför inte ytterligare serveranrop till Analytics (primär eller sekundär). </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_B7067B70FF85498896801F58D716202F"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Ja. I AAM-målkonfigurationen visas endast rapportsviter som har SSF aktiverat. </p> </td> 
  </tr> 
  <tr> 
...
Mer information om vanliga frågor och svar om det här avsnittet finns i Vanliga frågor om [vidarebefordran på serversidan](/help/admin/admin/c-server-side-forwarding/ssf-faq.md).
...
<table id="table_1F7C0C785F9C472286A96F8C25E8440B"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Se Förstå segment <a href="/help/integrate/c-audience-analytics/aam-analytics-segments.md"  > i Analytics och Audience Manager </a>. </p> <p>AAM-målgrupper skickas vidare och delas som"dimensionskomponenter" som ska användas i Analytics. De visas inte som segment i segmentbyggaren, till exempel, utan som dimensioner som du kan skapa segment med. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b>F: Vad är skillnaden mellan kundattribut och kunddata som är integrerade från AAM?</b> </p> </td> 
   <td colname="col2"> <p>Kundattribut är inte tidsbaserade; de tillämpar retroaktivt och går framåt. AAM-integrerade data är tidsbaserade och kan bara användas framåt. Dessutom är kundattribut ett sökregister för besökar-ID:n i Experience Cloud, medan AAM-integreringen är data sammanfogade i varje träff för en besökare. </p> </td> 
  </tr> 
  <tr> 
