...
3. [Rapport om Advertising-data i Analytics](/help/integrate/c-advertising-analytics/c-adanalytics-workflow/aa-report-ad-data-an.md). Sökdata hämtas från sökmotorer runt 6.00 (06:00) i tidszonen i ditt Adobe Analytics datacenter. Adobe Advertising data samlas in och infogas i rapportsviten. Och konverteras sedan till rapportsvitens tidszon som en del av infogningen av data i Analytics. Rapportering är tillgängligt i Analysis Workspace (mallen för betalningsprestanda), Report Builder och API:t för analysrapportering.
