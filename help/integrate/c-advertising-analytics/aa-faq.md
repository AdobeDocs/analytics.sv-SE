...
<table id="table_6713C3B0B6734F768370F974EB5AC5E8"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>F: Måste jag vara <b>Adobe Advertising Cloud- eller Adobe Advertising Cloud-kund (AMO)</b> för att få tillgång till den här funktionen? </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>F: Vilka <b>Adobe Analytics SKU:er</b> berättigar dig till användning av Advertising Analytics? </p> </td> 
   <td colname="col2"> <p>S: Advertising Analytics finns för Adobe Analytics <a href="https://www.adobe.com/se/data-analytics-cloud/analytics/select.html"  > Select </a>, <a href="https://www.adobe.com/se/data-analytics-cloud/analytics/prime.html"  > Prime </a> och <a href="https://www.adobe.com/se/data-analytics-cloud/analytics/ultimate.html"  > Ultimate </a> SKU:er. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>F: Måste vi <b>betala extra</b> för att använda Advertising Analytics? </p> </td> 
   <td colname="col2"> <p>S: Nej, vid sidan av rätt SKU-etablering medför Advertising Analytics inte någon extra kostnad. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>F: Räknas Advertising Analytics med min <b>användning av serversamtal</b>? </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>F: Om jag <b>redan använder Advertising Cloud/AMO</b>, kan jag ändå använda Advertising Analytics-funktionen? </p> </td> 
...
<table id="table_4EC69262B7AB4DF49E736CF3B0362302"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>F: Var går jag till <b>åtkomst</b> Advertising Analytics? </p> </td> 
   <td colname="col2"> <p>S: När du har loggat in på Adobe Analytics går du till menyn <span class="uicontrol"> Admin </span>. Välj sedan det nya menyalternativet <span class="uicontrol"> Advertising Analytics </span> för att lägga till dina sökmotorkonton. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>F: Hur samlas <b>data in och skickas till Analytics</b>? </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>F: Kan jag <b>dela upp mina Advertising Analytics-data</b> med andra analysdata (mått/mått)? </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>S: Var och en av dessa statusindikatorer identifierar livscykelstadiet för varje sökmotorkonto. </p> 
    <ul id="ul_F68AD377B2F04A47B20355B2FF4CF345"> 
     ...
     <li id="li_42B1557A8AEC41008B85AF6E3F625CAB"><b></b> Pausad innebär att kontot tidigare har konfigurerats men har försatts i ett inaktivt läge. </li> 
     <li id="li_30B72CC171874F308A2B8CE552EA6930"><b>Aktivering </b> innebär att kontot har konfigurerats helt och sökdata hämtas. </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>F: Jag försöker <b>mappa mina Advertising Analytics-konton till en viss rapportsvit</b>, men den är inte tillgänglig i modal Report Suite. Varför? </p> </td> 
   <td colname="col2"> <p>S: Innan du kan tilldela ett Advertising Analytics-konto en rapportsserie måste önskad rapportsvit vara <a href="/help/integrate/c-advertising-analytics/c-adanalytics-workflow/aa-provision-rs.md"  > för Advertising Analytics-rapportering </a>. </p> <p>Detta görs via en separat admin-sida som är tillgänglig från: <span class="ignoretag"> <span class="uicontrol"> Admin </span> &gt; <span class="uicontrol"> Rapportsviter </span> &gt; <span class="uicontrol"> [select Experience Cloud-enabled report suite] </span> &gt; <span class="uicontrol"> Redigera inställningar </span> &gt; <span class="uicontrol"> Advertising Analytics Configuration </span> </span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>F: Är det möjligt att tilldela ett Advertising Analytics-konto en <b>Virtual Report Suite</b> (VRS)? </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>F: Kan Advertising Analytics-statistik rapporteras i <b>marknadsföringskanalerna</b>-rapporten? </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>F: Vad kan vara <b>taget innan du klickar på</b>? Ger vi intryck, kostnader, genomsnittlig position osv. även utan att klicka? </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>F: På vilken nivå hämtas dessa data? <b>Besökare? Träff?</b> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>F: Finns det planer på att inkludera andra annonskanaler som <b>Display</b> eller <b>Social</b>? </p> </td> 
...
<table id="table_9738FF8459574ED2937A860A665BE739"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>F: När mitt Advertising-konto konfigureras anges att <b> automatisk spårning</b> kan leda till oönskade konsekvenser. Vilka typer av följder kan inträffa? </p> </td> 
   <td colname="col2"> <p>A: 
