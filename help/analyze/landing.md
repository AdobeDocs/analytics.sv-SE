...
Om du vill lägga till eller ta bort kolumner från listan med projekt klickar du på kolumnikonen (![Landning av alla](/help/analyze/assets/select-column.png) ) i det övre högra hörnet och markera eller avmarkera sedan kolumnrubriker.
