...
| --- | --- | --- |
| Expandera [!UICONTROL Projects] tabell till helskärm | Klicka bara på menyikonen för hamburgaren om du vill expandera tabellutrymmet. Den här åtgärden komprimerar flikarna till vänster. | ![Expandera tabell](assets/landing-collapse.png) |
...
| Nya länkar till rapporter och analysrapporter | <ul><li>Rapporter > Målgrupp > Bots</li><li>Rapporter > Målgrupp > Punktsidor<li>Rapporter > Engagement > Real-Time</li></ul> | ![Nya länkar](assets/report-links.png) |
| Nya färdiga rapporter | <ul><li>Rapporter > Mest populära > Nästa sida</li><li>Rapporter > Mest populära > Föregående sida</li><li>Rapporter > Engagemang > Sidanalys > Sidsammanfattning</li></ul>Observera att dessa rapporter är i Workspace-format och kräver konfiguration och bygge. Resultatet består av en panel med högnivåstatistik, trenddata, [!UICONTROL Flow] visualisering med mera. Du kan också ändra de här rapporterna och ändra dimensioner, dimensionsobjekt osv. Dessa rapporter finns också som paneler under arbetsytepaneler. | ![Nästa sida](assets/next-page.png) |
| [!UICONTROL Create new] modal är tillbaka | När du klickar [!UICONTROL Create new] i Workspace får du ännu en gång möjlighet att välja mellan ett tomt projekt och ett tomt mobilstyrkort. Du kan också välja bland de mallar som företaget har skapat. | ![Skapa nytt](assets/create-new.png) |
...
| Tomt projekt | Skapar en tom [Arbetsyteprojekt](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/home.html?lang=en) för att fylla i. |
| Tomt mobilstyrkort | Skapar en tom [mobilstyrkort](https://experienceleague.adobe.com/docs/analytics/analyze/mobapp/curator.html?lang=en) för att fylla i. |
...
| Fråga | Svar |
| --- | --- |
| Var är mallarna jag är van vid att se i Workspace? | Mallarna är grupperade under [!UICONTROL Reports] -fliken. |
...
| Överförs mina nuvarande favoriter i Rapporter och analyser? | Nej, de förs INTE vidare. Alla projektfavoriter på arbetsytan överförs dock. |
