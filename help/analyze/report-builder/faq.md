...
## Kan jag använda `TODAY()` eller `DATERANGE()` fungerar i arbetsböcker? {#today}
...
Du måste beviljas åtkomst via Report Builder av din Adobe Analytics-administratör. Administratören ställer in produktprofiler i [Adobe Admin Console](https://experienceleague.adobe.com/en/docs/analytics/admin/admin-console/home). Be din administratör att ge dig åtkomst.
