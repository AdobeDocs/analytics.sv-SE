...
| `|` | eller<br>Obs! Du måste ha ett blanksteg på varje sida om lodstreck, `" | "`. |
...
1. Klicka på knappen **[!UICONTROL Filter]** länk.
...
1. Klicka på knappen **[!UICONTROL Correlation Filter]** länk.
