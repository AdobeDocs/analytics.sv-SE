...
Som varningssystem för alla Adobe Analytics-system kan du med intelligenta aviseringar skapa och hantera aviseringar och även tillhandahålla funktioner för förhandsgranskning av aviseringar och regelbidrag. Du kan
...
1. Klicka **[!UICONTROL More]** > **[!UICONTROL Add Alert]**.
