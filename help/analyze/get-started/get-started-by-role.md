...
Det finns 4 typer av Adobe Analytics-användare i en typisk organisation:
...
Följande är några av de kanaler som stöds där data kan samlas in:
...
| **Mobilappar** | <ul><li>Tillägg för mobil SDK (rekommenderas)</li><li>Analytics-tillägg</li></ul> |
...
|---------|----------|---------|
| Definiera administratörsroller | Adobe Analytics stöder olika typer av administratörer | [Administratörsroller i Adobe Analytics](https://experienceleague.adobe.com/docs/analytics/admin/admin-console/admin-roles-in-analytics.html) |
...
| Bidragsanalys | Använd Analysis Workspace för att upptäcka dolda mönster i era data för att förklara statistiska avvikelser och identifiera korrelationer bakom oväntade kundåtgärder, out-of-bound-värden och plötsliga toppar eller dalar för mätvärden i olika målgruppssegment. | [Översikt över bidragsanalys](/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md#contribution-analysis) i [Avvikelseidentifiering](/help/analyze/analysis-workspace/c-anomaly-detection/anomaly-detection.md) |
...
Slutanvändare som inte är professionella analytiker kan antingen arbeta med analytiker i sin organisation för att utnyttja den fulla kraften i Adobe Analytics och Analysis Workspace, eller så kan de lära sig grunderna i Analysis Workspace för att börja få användbara insikter om sina kunder.

### Arbeta med analytiker

Vanligtvis är användare i en organisation som är intresserade av att lära sig mer om kundbeteende på sina olika webbplatser inte professionella analytiker.
...
[Med API:](https://developer.adobe.com/analytics-apis/docs/2.0/) er för analys kan du anropa Adobe servrar direkt för att utföra nästan alla åtgärder som du kan utföra i användargränssnittet.

Du kan skapa rapporter för att utforska, få insikter eller besvara viktiga frågor om dina data. Du kan också hantera komponenter i Adobe Analytics, t.ex. skapa segment eller beräknade värden.
