---
description: Activity Map har två grundläggande sätt att ge kompletterande rapportering av sidaktivitet.
...
Activity Map har två grundläggande sätt att ge kompletterande rapportering av sidaktivitet.

* Standardläge, i vilket [länkar i sidrapporter](/help/analyze/activity-map/activitymap-links-report.md)länkar data från en dag till flera dagar, aggregerade över hela datumintervallet.
