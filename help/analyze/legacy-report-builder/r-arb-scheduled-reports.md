...
Du kommer även fortsättningsvis att kunna schemalägga Report Builder-uppgifter per timme och få dem att sluta efter högst 99 tillfällen. Observera att återställningen endast gäller för timuppgifter. &quot;slut efter x förekomster&quot; kommer inte att vara tillgängligt för alla andra leveransintervall (dag, vecka, månad och år).
...
| [!UICONTROL Publishing Options] | Den här kolumnen visar Power BI om något av [Power BI publiceringsalternativ](/help/analyze/legacy-report-builder/c-publish-power-bi/power-bi.md) har valts. |
