...
*I den här artikeln dokumenteras utfallsvisualiseringen i **Adobe Analytics**.<br/>Se [Utfall](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/fallout/fallout-flow) för **Customer Journey Analytics**-versionen av den här artikeln.*
