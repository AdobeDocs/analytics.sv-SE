...
*I den här artikeln beskrivs punktvisualiseringen i **Adobe Analytics**.<br/>Se [Bullet](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/bullet-graph) för **Customer Journey Analytics**-versionen av den här artikeln.*
