...
Följande information beskriver hur du får åtkomst till och använder färdigbyggda rapporter från fliken [!UICONTROL Reports] i Analysis Workspace.
...
En lista över tillgängliga rapporter finns i avsnittet [Tillgängliga rapporter](#available-reports) nedan.
...
1. Gå till fliken [!UICONTROL **Rapporter**].
1. Markera den rapport som du vill visa. Välj till exempel rapporten [!UICONTROL **Sidor**] under [!UICONTROL **Mest populära**].
