...
| [Dela](https://experienceleague.adobe.com/sv/docs/analytics/analyze/analysis-workspace/curate-share/send-schedule-files) | Kuratera, dela och schemalägg PDF/CSV-projekt för mottagare i organisationen. |
