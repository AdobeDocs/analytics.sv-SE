...
>[!NOTE] **[!UICONTROL Custom lookback windows]** har för närvarande begränsad testning. Mer information finns i [funktionsreleaser](/help/landing/an-releases.md) för Adobe Analytics.
