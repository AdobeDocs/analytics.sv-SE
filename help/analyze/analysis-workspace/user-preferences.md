...
>[!IMPORTANT]
>
>Du kan inte längre definiera talformatet i avsnittet **[!UICONTROL Project & Analyses]** > **[!UICONTROL Data]** i **[!UICONTROL User preferences]**. Talformatet bestäms automatiskt av standardspråket [som är konfigurerat](https://experienceleague.adobe.com/sv/docs/core-services/interface/features/browser-language) för den inloggade användaren.
>
