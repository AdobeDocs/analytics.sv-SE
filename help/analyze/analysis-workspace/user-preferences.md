...
Se ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Hantera inställningar](https://experienceleague.adobe.com/sv/docs/analytics-learn/tutorials/intro-to-analytics/customizing-the-ui/user-preferences){target="_blank"} för en demonstrationsvideo.
...
>abstract="Välj standardmåttet som ska användas för frihandstabeller. Om den valda rapportsviten inte innehåller det valda standardmåttet ändras tabellen automatiskt till ett annat primärt mått."
