---
description: Lär dig hur du använder Analytics for Target-panelen för att analysera dina Adobe Target-aktiviteter och -upplevelser i Analysis Workspace.
title: Analyser för målpanel
feature: Panels
role: User, Admin
...
Se ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Analytics for Target panel](https://experienceleague.adobe.com/sv/docs/analytics-learn/tutorials/integrations/target/analytics-for-target-a4t-panel-in-analysis-workspace){target="_blank"} för en demonstrationsvideo.
