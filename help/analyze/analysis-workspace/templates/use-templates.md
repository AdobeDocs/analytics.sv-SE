...
| [!UICONTROL **Realtid**] | Visa de dimensioner och mätvärden som samlas in på din webbplats. <p>**Det här kan hjälpa dig** att bättre förstå vad som är trender på din webbplats.</p><p>**Baserat på vad du lär dig kan du** svara på och aktivt hantera prestandan för ditt aktuella marknadsföringsinnehåll och -kampanjer.</p> <p>Den här mallen använder [realtidsrapporten](/help/admin/tools/manage-rs/edit-settings/realtime/realtime.md).</p> |
...
>title="Se alla era sökdata från Google Ads och Microsoft Advertising sida vid sida."
...
| **Advertising Analytics: betalsökning** | Se alla era sökdata från Google Ads och Microsoft Advertising sida vid sida. <p>**Detta kan hjälpa dig** att bättre förstå hur mycket trafik som skickas till din webbplats och om kunderna konverterar.</p><p>**Baserat på vad du lär dig kan du** göra ett antal saker, som att uppskatta kostnadseffektiviteten för en annonskampanj.</p> |
