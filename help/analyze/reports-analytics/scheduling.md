...
> * Förutom den specifika rapporttypen (Dashboards, etc.) väntar rapporter också i rad om företaget har **mer än 15-20 av någon typ av rapport som schemaläggs samtidigt (för alla olika rapporttyper)**. Detta kan minskas genom att tidsintervallen ökas i stället för att många körs exakt samtidigt.
> * **Problem i tjänster** längre fram i kedjan som Schemaläggaren förlitar sig på kan också påverka rapportleveransen. Om du t.ex. använder API:erna separat för att köra rapporter och fylla i API-begärandekön kan dina schemalagda rapporter leverera långsamt medan du konkurrerar om den resursen.
...
1. Välj önskat format för rapporten:
   ...
   * **[!UICONTROL PDF]**: Anger att rapporten kommer att laddas ned i Adobe PDF-format, vilket gör att du kan dela rapporten med andra, oavsett vilket datorsystem mottagaren kör.
...
Här [!UICONTROL Schedule Report Manager] visas de objekt som en viss användare har skapat. Om användarkontot är inaktiverat i programmet stoppas alla schemalagda leveranser.

1. Du öppnar hanteraren genom att klicka **[!UICONTROL Analytics]** > **[!UICONTROL Components]** > **[!UICONTROL Scheduled Reports]**.
...
1. Klicka på **[!UICONTROL click here]** länken bredvid **[!UICONTROL To cancel automatic delivery of this report]**.
