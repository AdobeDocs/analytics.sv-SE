...
1. Klicka **[!UICONTROL 3 x 2]** eller **[!UICONTROL 2 x 2]** ange hur många rapporter du vill ha på kontrollpanelssidan.
1. Konfigurera sidlayouten för kontrollpanelen:
   ...
   * **[!UICONTROL Find Content]**: Gör att du kan söka efter innehåll på [!UICONTROL Add Content] - och [!UICONTROL Dashboard Contents] menyerna.

1. Lägg till tillgängligt innehåll på kontrollpanelen genom att dra objekt till rapportletens arbetsyta.

   Se [Skapa en portlet](/help/analyze/reports-analytics/dashboard.md#task_EC3AFBBAA51C45CEBAF632F841C305B3) och [Redigera inställningar](/help/analyze/reports-analytics/dashboard.md#task_90D7FAC1CC3E4DB786B4C87CC33B5459)för kontrollpanelen.
1. Klicka på **[!UICONTROL Save.]**

   Om du sparar en kontrollpanel blir den tillgänglig på **[!UICONTROL Dashboard]** menyn. Den nya kontrollpanelen finns också i [!UICONTROL Dashboard Manager] ( **[!UICONTROL Favorites]** > **[!UICONTROL Dashboards]** > **[!UICONTROL Manager]**) där du kan redigera, ordna, dela, schemalägga, arkivera kontrollpaneler med mera. (Se [Hantera instrumentpaneler](/help/analyze/reports-analytics/dashboard-manage.md).)
...
1. Namnge rapporten på [!UICONTROL Add Reportlet] sidan och välj sedan en kontrollpanel **[!UICONTROL Place in Dashboard]**.
1. (Valfritt) Konfigurera datumintervallet.

   * **[!UICONTROL Rolling]**: Ändrar datumet allt eftersom tiden går, enligt tidsrymden (dag, månad och så vidare). Om idag till exempel är 17 januari kan du ange datum för 15-16 januari. Om du väljer **[!UICONTROL Rolling]** det här alternativet visas data för 25-26 januari den 27 januari.
...
1. Klicka på **[!UICONTROL Create New]**.
   ...
   Rapportleten läggs till på **[!UICONTROL Dashboard Contents]** menyn i instrumentpanelsredigeraren.
...
1. Klicka **[!UICONTROL Add Content]** och dra sedan objekt till kontrollpanelen.

   På [!UICONTROL Add Content] menyn visas rapportletinnehåll från andra instrumentpaneler, äldre instrumentpaneler och delade instrumentpaneler.
...
Du kan skapa följande rapporter för användarinnehåll genom att ange URL:er. Om en bild eller en annan resurs-URL inte börjar med https:// kan Internet Explorer-användare se en varning om blandat innehåll. Du kan inaktivera varningen för blandat innehåll i säkerhetsinställningarna för webbläsaren.
   ...
   * Bild: Gör att du kan skapa en kontrollpanel från en bild-URL. Om HTTP-protokollet används i URL:en utfärdas en varning om blandat innehåll. Om du använder en URL med HTTPS tas varningen bort. Alla andra protokoll genererar ett `Specified URL could not be retrieved` fel.
...
1. Klicka **[!UICONTROL Components]** > **[!UICONTROL Dashboards]** > *instrumentpanelens namn* för att öppna en instrumentpanel.
...
1. På [!UICONTROL Company Settings] sidan klickar du på **[!UICONTROL Co-Brand the Adobe Experience Cloud]**.
