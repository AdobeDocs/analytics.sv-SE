...
Under flera år har du kunnat skicka in data på träffnivå till Adobe Analytics med fullständig databehandling. Dessa data bearbetades på samma sätt som data som samlats in via våra JavaScript-bibliotek och SDK för mobilappar. 2020 släppte Adobe [API för massdatainmatning](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/bdia.md), som utför samma funktioner som Fullständig bearbetning av datakällor, men med ytterligare funktioner. Det här avsnittet innehåller information om ytterligare funktioner som tillhandahålls av API:t för inmatning av gruppdata och visar skillnader i filformat.

Från och med 25 mars 2021 hindrade Adobe från att skapa nya anslutningar för fullständiga datakällor. Befintliga anslutningar stöddes tills tjänsten var helt inaktuell den 31 januari 2022. Förutom vår standarddokumentation tillhandahåller vi en genomgång av [steg som krävs för att skicka data via API:t för datainfogning i grupp](https://adobe.ly/aabdia).

## Varför slutade vi den här funktionen?

BDIA (Bulk Data Insertion API) ger ytterligare funktioner och täcker alla användningsfall som stöds av Fullständig bearbetning. Det är bättre att använda API:t för datainfogning i grupp.
...
* Datainfogning i grupp stöder flera alternativ för besökar-ID:n. Du kan skicka både Analytics ID och Marketing Cloud ID (se [Identitetstjänst](https://experienceleague.adobe.com/docs/id-service/using/home.html) om du vill veta mer). Dessutom kan du använda ditt eget ID som [utsäde för att generera ett ECID](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/bdia.md#customer-id-and-experience-cloud-visitor-id-seeds).
...
* Det finns ytterligare obligatoriska fält för infogning av gruppdata. Se [dokumentation](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/bdia.md) för mer information.
