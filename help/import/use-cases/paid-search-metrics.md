...
[!UICONTROL Success events] är åtgärder som kan spåras. Du bestämmer vad en [!UICONTROL success event] är. För att kunna spåra [!UICONTROL paid search]-mått vill vi ställa in [!UICONTROL success events] runt [!UICONTROL clicks], [!UICONTROL impressions], [!UICONTROL total cost] och aktivera[!UICONTROL tracking codes].
...
[!UICONTROL Data Source Activation Wizard] visas:
...
c. Kontrollera att **[!UICONTROL Delimited]** är markerat i steg 1 i guiden och klicka på **[!UICONTROL Next]**.
