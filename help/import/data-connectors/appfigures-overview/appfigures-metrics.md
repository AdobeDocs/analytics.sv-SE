---
description: Följande mått synkroniseras som en del av integreringen av appFigures.
...
Följande mått synkroniseras som en del av integreringen av appFigures.

| Mått | Beskrivning |
|---|---|
| App Store-nedladdningar | Antalet nedladdningar av mobilprogram. |
| App Store-inköp (i app) | Antalet köp i appen. |
| Rankning för App Store | Används för att definiera det genomsnittliga beräknade måttet appFigures. Används inte direkt. |
| Rangordning för App Store | Används för att definiera det genomsnittliga beräknade måttet appFigures. Används inte direkt. |
| App Store-klassificering | Används för att definiera det genomsnittliga beräknade måttet appFigures. Används inte direkt. |
| Klassificeringsdivisor för App Store | Används för att definiera det genomsnittliga beräknade måttet appFigures. Används inte direkt. |
| App Store-intäkter (i app) | Belopp i appintäkter. |
| App Store-intäkter (en av) | Inkomstbeloppet som är associerat med köpet av en app. |
| App Store Royalty (i app) | Föråldrat. |
| App Store Royalty (en av) | Föråldrat. |

Följande reserverade klassificeringsdimensioner skapas av databindningsguiden för det AppFigures-objekt-ID som är reserverat för eVar.

| Klassificeringsdimension | Beskrivning |
|---|---|
| Land | Namnet på det land som är relaterat till appbutiksaktiviteten. |
| Enhetsnamn | Namnet på den mobila enheten som är relaterad till appbutiksaktiviteten. |
| Appstore-namn | Namnet på appstore som rapporterade aktiviteten. |
| Programnamn | Namnet på mobilprogrammet. |
| Namn i programmet | Objektet som köpts i programmet. |
| Kategorinamn | Primär kategori för appen i appbutiken. |
| Granskningstitel | Granskningens namn. |
| Granska kommentar | Granskningens kommentar |
| Programversion | Version av programmet som användes för att generera granskningen. |
| App Store-användare | Författare (användarnamn) till granskningen. |

Följande beräknade mått skapas av guiden för dataanslutningar:

| Beräknade mått | Beskrivning |
|--- |--- |
| Genomsnittlig rangordning för App Store (numerisk) | Genomsnittlig apprankning. Detta beräknade mått definieras med följande formel:   `[App Store Rank]` / `[App Store Rank Divisor]` <br> Obs!  Antalet program per kategori och land varierar mellan appbutiker. Om ditt program rangordnas under detta tröskelvärde är inte programrangordningarna tillgängliga. |
| Genomsnittlig klassificering i App Store | Genomsnittlig appklassificering. Detta beräknade mått definieras med följande formel:  `[App Store Rating]` / `[App Store Rating Divisor]` |

## Relevanta dimensioner för varje AppFigures-mått {#section-cd356d3dce04412893beed345305c247}

Tabellen nedan visar vilka rapportdimensioner som relaterar till vilka mätvärden.

<table id="table_B9CF57EABE22449FBF1963E3F105E702"> 
 <tbody> 
  <tr> 
   <td> </td> 
   <td> Hämtningar i App Store </td> 
   <td> App Store-inköp (i appen) </td> 
   <td> Rankning för App Store </td> 
   <td> Rangordning för App Store </td> 
   <td> App Store-klassificering </td> 
   <td> Klassificeringsdivisor för App Store </td> 
   <td> App Store-intäkt (i appen) </td> 
   <td> App Store-intäkt (engångs) </td> 
   <td> App Store - medel Rankning </td> 
   <td> App Store - medel Klassificering </td> 
  </tr> 
  <tr> 
   <td> Land </td> 
  ...
  <tr> 
   <td> Namn på rankningskategori </td> 
