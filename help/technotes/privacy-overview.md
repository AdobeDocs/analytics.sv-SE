...
* **Web SDK**: Ett bibliotek utformat för att skicka data till Adobe Experience Platform Edge-nätverket, som sedan vidarebefordrar dessa data till Adobe Analytics.
...
På navigeringsmenyn under [Översikt över Dimensioner](../components/dimensions/overview.md) och [Metrisk översikt](../components/metrics/overview.md) finns fler variabler som Adobe kan samla in data under.
