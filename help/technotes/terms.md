...
* **Aktivitetskarta:** En webbläsarplugin som visar vilka områden på webbplatsen som du klickade mest på. Se [Aktivitetskarta](/help/analyze/activity-map/activity-map.md) i användarhandboken för Analysera.
...
* **Datalager:** En funktion i Adobe Analytics som gör att ni kan begära större rapporter. Se [Datalager](/help/export/data-warehouse/data-warehouse.md) i användarhandboken för Export.
...
* **Flöde:** En typ av visualisering i Analysis Workspace som visar vilka sökvägar användarna har tagit på din webbplats. Se [Flödesvisualisering](/help/analyze/analysis-workspace/visualizations/c-flow/flow.md) i användarhandboken för Analysera.
...
* **Bearbetar regler:** Kan referera till:
   * Bearbetar regler, ett sätt att ändra datainsamling med hjälp av vissa regler i Admin Console. Se [Bearbeta regler](/help/admin/admin/c-processing-rules/processing-rules.md) i användarhandboken för Admin.
