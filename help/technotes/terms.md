...
* **Admin Console:** Kan referera till:
   ...
   * Admin Console i Adobe, där produktåtkomst tillhandahålls och användarbehörigheter hanteras. See [Admin Console](/help/admin/admin-console/home.md) in the Admin user guide.
...
* **Konverteringsvariabel:** Kallas också eVars. Sparar ett anpassat värde och bevarar variabelvärdet tills det upphör att gälla. Se [eVar](/help/components/dimensions/evar.md) i användarhandboken för komponenter.
...
* **Kundsupport:** En utsedd användare som har rätt att interagera direkt med Adobe kundtjänst. Se [Kundsupportrepresentanter](https://helpx.adobe.com/experience-cloud/supported-users.html) i Experience Cloud Knowledgebase.
...
* **Starta:** För Adobe Experience Platform Launch är den nuvarande implementeringslösningen i Adobe. Se [Översikt](https://docs.adobe.com/content/help/en/launch/using/overview.html) i användarhandboken för Adobe Experience Platform Launch.
...
* **Bearbetar regler:** Kan referera till:
   * Bearbetningsregler är ett sätt att ändra datainsamling med hjälp av vissa regler i Admin Console. Se [Bearbeta regler](/help/admin/admin/c-processing-rules/processing-rules.md) i användarhandboken för Admin.
