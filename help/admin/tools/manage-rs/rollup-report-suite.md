...
Adobe rekommenderar att man i de flesta fall genomför en global rapportserie. Se [Överväganden för den globala rapportsviten](/help/implement/prepare/global-rs.md) för fördelarna med att implementera en global rapportserie.
