...
* Skapa en eller flera kanaler så att du kan tilldela regler till dem. Se [Lägg till marknadsföringskanaler](/help/admin/tools/manage-rs/edit-settings/marketing-channels/c-channels.md).
...
Mer information om varför den här kanalen inträffar finns i [Orsaker till intern (sessionsuppdatering)](/help/components/c-marketing-channels/c-faq.md#internal).
