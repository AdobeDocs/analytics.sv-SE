...
Beskrivningar av fält som används när [redigera konverteringsvariabler](/help/admin/admin/conversion-var-admin/t-conversion-variables-admin.md).
...
| [!UICONTROL Status]  (endast eVar) | Definierar [!UICONTROL eVar] status:<ul><li>**Handikappade**: Inaktiverar [!UICONTROL eVar]. Tar bort [!UICONTROL eVar] från listan med konverteringsvariabler.</li><li>**Inga underrelationer**: Hindrar dig från att bryta ned [!UICONTROL eVar] efter dimension.</li><li>**Grundläggande underrelationer**: Gör att du kan dela upp en eVar i en hel dimension (till exempel Produkter eller Campaign).</li></ul> |
...
| [!UICONTROL Merchandising]  (endast eVar) | Merchandising-variabler kan följa på en av två syntaxer:<ul><li>**[!UICONTROL Products Syntax]**: Associerar eVar med en produkt. **Anteckning**: If [!UICONTROL Products Syntax] är markerat, [!UICONTROL Merchandising Binding Event] -avsnittet är inaktiverat och kan inte markeras för redigering. För den här syntaxen [!UICONTROL Binding Events] är inte tillämpliga.</li><li>**[!UICONTROL Conversion Variable Syntax]**: Associerar endast eVar med en produkt om en [!UICONTROL Binding Event] inträffar. I det här fallet väljer du de händelser som fungerar som [!UICONTROL Binding Events].  Om du ändrar den här inställningen utan att uppdatera JavaScript-koden därefter, kommer förlorade data att uppstå. Se [Marknadsföringsvariabler](/help/components/dimensions/evar-merchandising.md).</li></ul> |
| [!UICONTROL Merchandising Binding Event] (endast eVar) | Om Merchandising är inställt på [!UICONTROL Conversion Variable Syntax]binder de markerade händelserna det aktuella eVar med en produkt. Så här använder du en [!UICONTROL Binding Event], ange [!UICONTROL Allocation] till [!UICONTROL Most Recent]. If [!UICONTROL Allocation] är inställd på [!UICONTROL Original Value], den första produktbindningen för eVar återstår tills eVar går ut. Du kan välja flera händelser genom att hålla ned Ctrl (Windows) eller Cmd (Mac) och klicka på flera objekt i listan. Du kan bara välja en händelse när [!UICONTROL Conversion Variable Syntax] är markerat. |
