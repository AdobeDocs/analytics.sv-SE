 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>Dessa förblir tillgängliga för er i användarhanteringen i Analytics. </p> <p>Se <a href="/help/admin/user-management2/user-migration/c-migration-tool.md"> Analysfunktionerna i Admin Console stöds inte</a> för mer information. </p> </td> 
  </tr> 
  <tr> 
