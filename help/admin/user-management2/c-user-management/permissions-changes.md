...
<table id="table_D1DB0DE37752450BBCCA44DB760BB505"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Rekommenderas endast för nya kunder eller kunder med företag <a href="https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services.html"> etablerade i Experience Cloud</a>. En migrering av befintliga <span class="keyword"> Analytics</span> -kunder till <span class="keyword"> identitetshanteringssystemet Experience Cloud</span> planeras. </p> <p>Mer information finns i Hantera <a href="https://helpx.adobe.com/enterprise/using/manage-permissions-and-roles.html"> produktbehörigheter i Admin Console</a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_1E93F45C66E841E6882FB602509F30A3"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p>Bör jag använda Admin Console för att hantera användare eller den befintliga Analytics användarhantering? </p> </td> 
   <td colname="col2"> <p>Ändringar som görs i Analytics &gt; Admin &gt; Användarhantering återspeglas inte i Admin Console. Därför bör endast nya kunder som redan använder Admin Console för användar- och grupphantering fortsätta göra det. En migrering av Analytics befintliga grupphantering till Admin Console planeras. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_B68FD00FC5D24823A86BB69558C0327C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Admin Console - för användare av Experience Cloud </p> <p>Administratörsverktyg - för alla användare, men för Experience Cloud-användare, tas endast den mappade Analytics-användaren bort, inte Experience Cloud-kontot. </p> </td> 
   <td colname="col3"> <p>Admin Console - för migrerade användare. </p> <p>Administratörsverktyg - för användare som endast använder Analytics. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>Experience Cloud: </b> <span class="filepath"> marketing.adobe.com</span>. Endast tillgängligt för användare av Experience Cloud. </p> <p> <b>Analytics (äldre):</b> <span class="filepath"> sc.omniture.com</span>. Endast för användare av Analytics och för användare av Experience Cloud med Analytics-uppgifter </p> </td> 
   <td colname="col3"> <p> <span class="filepath"> marketing.adobe.com</span> - endast för användare av Experience Cloud. </p> <p> <span class="filepath"> sc.omniture.com</span> - Endast för analytiker och för Experience Cloud med inloggningsuppgifter för Analytics. </p> <p>Under migreringen kan administratörer inaktivera inloggningsfunktionen <span class="filepath"> omniture.com</span> för specifika användare. </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Admin Console (<a href="https://docs.adobe.com/content/help/sv-SE/core-services/interface/manage-users-and-products/admin-getting-started.html"> skapa produktkonfiguration</a>) </p> </td> 
   <td colname="col4"> <p>Admin Console (<a href="https://docs.adobe.com/content/help/sv-SE/core-services/interface/manage-users-and-products/admin-getting-started.html"> skapa produktkonfiguration</a>) </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Redigera användare i en grupp </td> 
   <td colname="col2"> <p>Admin Console - endast för Experience Cloud </p> <p>Administratörsverktyg - Både användare med endast Analytics och användare i Experience Cloud kan redigeras i administratörsverktygen. Om en Experience Cloud-användare ingår i en grupp i Admin Console kan de inte tas bort från gruppen i Admin Tools. </p> </td> 
   <td colname="col3"> <p>Admin Console - endast Experience Cloud </p> <p> Administratörsverktyg - Det går fortfarande att lägga till/ta bort enbart Analytics-inloggningar från grupper i Administratörsverktyg. </p> </td> 
   <td colname="col4"> <p>Admin Console </p> </td> 
  </tr> 
  <tr> 
