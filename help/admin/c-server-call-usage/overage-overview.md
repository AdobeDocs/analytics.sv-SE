...
* **Synlighet** för era serversamtals förbrukning och åtagandedata, inklusive mobilförbrukning i förhållande till den avtalsenliga gränsen för hur många serversamtal du använder.
* **Varnar** för att meddela dig om risken eller förekomsten av ett överskott och förbereda för/agera på risken för att det kan uppstå överskott.

Tidigare uppdaterades dessa data endast 6 dagar efter att faktureringen hade stängts för den månaden, medan du kunde få åtkomst till månatliga förbrukningsdata för serversamtal under **[!UICONTROL Analytics]** > **[!UICONTROL Admin]** > **[!UICONTROL Billing]** . Uppgifterna inkluderade inte heller mobilförbrukning. Den här funktionen ersätter även den aktuella **[!UICONTROL Billing Information]** rapporten under **[!UICONTROL Analytics]** > **[!UICONTROL Reports]** .
