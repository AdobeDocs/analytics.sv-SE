  ...
  <tr> 
   ...
   <td colname="col2"> <p>Klockan 10.00 UTC på startdatumet för migreringen: </p> 
    <ul id="ul_25D1DBDF5C804D048E741F31550FF5F3"> 
     ...
     <li id="li_8A05137EC05C4FD5910E73FE58300DCB">Avsnittet Användarhantering på fliken Admin i Analytics är inställt på <span class="term"> skrivskyddad</span>. Du kommer inte längre att kunna skapa nya användare eller behörighetsgrupper här och du måste utföra båda dessa funktioner i Adobe Admin Console. Se <a href="/help/admin/admin-console/user-management2/user-migration/c-migration-tool.md#section-928ffba27a0446e0af575b720434ef56"> Analysfunktionerna i Adobe Admin Console stöds inte</a> för mer information. </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    </ul> <p>Dessa förblir tillgängliga för er i användarhanteringen i Analytics. </p> <p>Se <a href="/help/admin/admin-console/user-management2/user-migration/c-migration-tool.md"> Analysfunktionerna i Adobe Admin Console stöds inte</a> för mer information. </p> </td> 
  </tr> 
  <tr> 
