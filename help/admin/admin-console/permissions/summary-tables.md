...
Använd följande sammanfattningstabeller för att identifiera Adobe Analytics-behörigheter i Admin Console, efter logiska grupperingar.
...
| --- | --- | --- | --- | --- | --- |
| Kontosammanfattning | x |  |  |  | Ger åtkomst till Allmänna > Allmänna kontoinställningar i Report Suite Manager. |
...
| Report Suite-hantering | x |  |  |  | Ger åtkomst till Report Suite Manager, men tillåter inga ändringar. |
...
| --- | --- | --- | --- | --- | --- |
| Kodhanteraren | x |  |  |  | Vi har kvar dem i bakgrunden. Ger åtkomst till Admin > Alla administratörer > Kodhanteraren. I de flesta fall använder du i stället biblioteken som ingår i användargränssnittet för datainsamling. |
...
| Åtkomst till labb |  | x |  |  | Ger tillgång till Labs. |
