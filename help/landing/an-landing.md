...
## Lägg märke till den nya menystrukturen

Den övre menyn och den vänstra listen har ändrats.

![](assets/top-menus.png)

* Ändringar på menyn Top Analytics: Den översta menyn **[!UICONTROL Reports]** är inte längre där. De flesta rapporterna finns nu på menyn [!UICONTROL Reports] i den vänstra listen.
* Den vänstra listen har tre flikar: [!UICONTROL Projects], [!UICONTROL Reports] och [!UICONTROL Learning]. Vi diskuterar dessa närmare i följande avsnitt.

### Terminologi

Observera vissa ändringar i terminologi:
...
| Visa mindre/mer | Växlar mellan att inte visa och visa banderollen: ![](assets/top-banner.png) |
...
| Fäst ikon | **** NyttDu kan nu fästa objekt och de visas  ** alltid överst i listan. |
...
Här är de nya menyerna och deras undermenyer. Om du inte kan hitta en viss rapport kan du söka efter den genom att välja Sök på sida.
...
## Vanliga frågor om nya landningssidor {#landing-faq}
...
| Kan administratörer ange den här nya landningssidan för sina användare? | Nej, administratörer kan inte utse den nya landningssidan för användarnas räkning. Enskilda användare måste aktivera växeln själva. |
