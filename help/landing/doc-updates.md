...
| 25 november 2019 | Nytt avsnitt om [Intern marknadsföringskanal (sessionsuppdatering)](https://docs.adobe.com/content/help/en/analytics/components/marketing-channels/session-refresh.html). |
...
| 12 september 2019 | Ny dokumentation för [Journey IQ: Enhetsövergripande analyser](https://docs.adobe.com/content/help/en/analytics/components/cda/cda-home.html). |
| 28 augusti 2019 | Ny artikel om [progressiva webbappar (PWA) för Analytics](https://docs.adobe.com/content/help/en/analytics/analyze/pwa/pwa.html). |
