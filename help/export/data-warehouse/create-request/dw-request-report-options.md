...
title: Konfigurera rapportalternativ för en Data Warehouse-begäran
...
# Konfigurera rapportalternativ för en Data Warehouse-begäran

Det finns olika konfigurationsalternativ tillgängliga när du skapar en Data Warehouse-begäran. Följande information beskriver hur du konfigurerar rapportalternativ för begäran.
...
Så här konfigurerar du rapportalternativ för en Data Warehouse-begäran:
...
1. På sidan Ny begäran från Data Warehouse väljer du fliken [!UICONTROL **Rapportalternativ**].
...
1. Ange följande fält:
   ...
   | [!UICONTROL **Sortera efter mått**] | Tillhandahåller rankade uppdelningsrapporter i Data Warehouse, sorterade efter fallande måttvärde. Sortering efter mätvärden gör Data Warehouse-rapporter enklare att tolka, och gör dem enklare att jämföra med andra analytiska rapporter för uppdelning.<p>Mer information finns i [Sortera efter mått](/help/export/data-warehouse/sorting-by-metric.md).</p> |
...
1. Fortsätt konfigurera din Data Warehouse-begäran på fliken [!UICONTROL **Schemaläggningsalternativ**]. Mer information finns i [Konfigurera schemaläggningsalternativ för en Data Warehouse-begäran](/help/export/data-warehouse/create-request/dw-request-scheduling.md).
