...
# Konfigurera ett e-postmeddelande för en Data Warehouse-begäran

Det finns olika konfigurationsalternativ tillgängliga när du skapar en Data Warehouse-begäran. Följande information beskriver hur du konfigurerar ett e-postmeddelande för begäran.
...
Så här konfigurerar du ett e-postmeddelande för en Data Warehouse-begäran:
...
1. På sidan Ny begäran från Data Warehouse väljer du fliken [!UICONTROL **Meddelande via e-post**].
...
1. Välj [!UICONTROL **Spara begäran**] om du vill spara Data Warehouse-rapportbegäran.
