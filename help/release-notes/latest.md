...
| **Självstudiekurs (tips) för Analysis Workspace**<br/> Det finns nu en ny praktisk självstudiekurs som kan vägleda nya användare genom grunderna i att använda paneler, visualiseringar och komponenter i Analysis Workspace. <p>(Dokumentationslänk att följa.)<!--For more information, see "Learning paths" in "Customer Journey Analytics landing page".--></p> | | 18 mars 2026 |
