...
| ----------- | ---------- | ------- | ---- |
| **Stöd för säkra destinationer i nya Report Builder** | Nya exportmål har lagts till i Report Builder-tillägget. Följande molnlagringsmål stöds: <ul><li>Amazon S3 Role ARN</li><li>Google Cloud Platform</li><li>Azure SAS</li><li>Azure RBAC</li></ul> FTP stöds inte längre på grund av säkerhetsproblem. (Dokumentationslänk följer) |  | 19 juni 2025 (original 18 juni) |
