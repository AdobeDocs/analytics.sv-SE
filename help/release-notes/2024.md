...
| **Ange `contextData` fält via XDM** | Kunder som skickar data till Adobe Analytics via Experience Edge Network kan [ange kontextdatavärden](https://experienceleague.adobe.com/sv/docs/analytics/implementation/vars/page-vars/contextdata) direkt antingen i XDM eller i datadelen av nyttolasten. |  | Ute nu |
