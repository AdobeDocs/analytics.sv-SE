...
>[!IMPORTANT]
>
>Ett nytt och smidigt [Report Builder](/help/analyze/report-builder/rb-overview.md) är tillgängligt sedan 16 oktober 2024. Denna Report Builder stöds i macOS, Windows och webbläsare och kan användas med Adobe Analytics och Customer Journey Analytics.
...
>[!WARNING]
>
>Klassificeringsregelbyggaren tas bort **28 februari 2027**. Växla till [Klassificeringsuppsättningen anger regler](/help/components/classifications/sets/manage/rules.md) när den är tillgänglig för att säkerställa fortsatt funktionalitet.
>
