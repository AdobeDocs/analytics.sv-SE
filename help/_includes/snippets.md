...
| [!UICONTROL **Används ofta tillsammans med**] | Visar de fem komponenter som oftast används för den komponent som du visar. Listan baseras på data från de senaste 90 dagarna. Endast de komponenter som du har åtkomst till visas. |
| [!UICONTROL **Liknar**] | Visar 5 komponenter med liknande etiketter som den komponent du visar. Endast de komponenter som du har åtkomst till visas. |
