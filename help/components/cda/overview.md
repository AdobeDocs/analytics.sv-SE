...
>[!WARNING]
>
>Enhetsdiagram i enhetsövergripande analyser är [föråldrat](https://experienceleague.adobe.com/en/docs/discontinued/using/device-graph) och inte längre tillgängligt den **31 december 2025**. Växla en eventuell aktiverad virtuell rapportsvit för enhetsdiagram till den [fältbaserade metoden](/help/components/cda/field-based-stitching.md).
>


CDA (Cross-Device Analytics) är en funktion som omvandlar analyser från en enhetscentrerad vy till en personcentrerad vy. Därför kan analytiker förstå användarbeteende som fungerar på olika webbläsare, enheter och appar. Adobe stöder [fältbaserad stitching](field-based-stitching.md) som endast använder deterministisk matchning för att länka samman enheter.
...
Användning av enhetsövergripande analys kräver [fältbaserad sammanslagning](field-based-stitching.md).
...
Enhetsövergripande analys är en banbrytande och robust funktion, men har begränsningar i hur den kan användas. [Fältbaserad häftning](field-based-stitching.md) har också egna begränsningar.
