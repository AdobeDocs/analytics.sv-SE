...
| [!UICONTROL Time spent per visit] (sekunder) | *Antal sekunder per besök*<br> Representerar den genomsnittliga tiden som besökare interagerar med en viss dimensionspost under varje besök. | Analysis Workspace, rapporter och analyser |
| [!UICONTROL Time spent per visitor] (sekunder) | *Totalt antal sekunder som använts/unik besökare*<br> Representerar den genomsnittliga tiden som besökare interagerar med ett visst dimensionsobjekt under besökarens livstid (längden på deras cookie). | Analysis Workspace, rapporter och analyser |
