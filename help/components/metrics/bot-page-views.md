...
[Mätvärdet](overview.md) för startsidans vyer visar antalet sidträffar som matchar [punktreglerna](/help/admin/tools/manage-rs/edit-settings/general/bot-removal/bot-rules.md).
