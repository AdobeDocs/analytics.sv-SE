---
description: Adobe Analytics erbjuder olika tidsmått och mått. Ta reda på vad de är och hur de beräknas.
title: Tillagd tid
topic: Metrics
...
**Fråga 4: Hur skiljer sig[!UICONTROL Average Time Spent on Site]från[!UICONTROL Time Spent per Visit]?**
