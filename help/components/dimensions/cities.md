...
Dimensionsvärdena omfattar städer över hela världen. Exempelvärdena inkluderar `"New York (New York, United States)"`, `"Bangalore (Karnataka, India)"`eller `"London (London, United Kingdom)"`.
