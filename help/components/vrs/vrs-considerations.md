...
Adobes kundtjänst kan öka de unika värdegränserna för ett litet antal dimensioner, vilket helt kan eliminera detta problem. Kontakta ditt kontoteam och kundtjänst för mer information.
