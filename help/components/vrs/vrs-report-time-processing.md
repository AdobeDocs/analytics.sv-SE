...
Se ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Starta ett nytt besök med event](https://experienceleague.adobe.com/sv/docs/analytics-learn/tutorials/components/virtual-report-suites/start-a-new-visit-on-any-event-in-virtual-report-suites){target="_blank"} för en demonstrationsvideo.
...
* **Dimensioner med (låg trafik) eller &quot;Uniques Exceeded&quot;:** Radobjektet (låg trafik) bestäms något annorlunda när Report Time Processing används och är inte garanterat för att matcha det som observeras vid rapportering på basrapportsviten. Det är inte säkert att Dimension-radartiklar som inte ingår i lågtrafik motsvarar 100 % av radpostens data. Dessa skillnader kan bli mer uttalade ju högre antal unika värden som finns i en dimension.
